...
def test_simple_calories_ingredients_mealType_match():
    ...
    calories = 700
    mealType = "breakfast"
    assert len(getRecipesWithCaloriesIngredientsMealType(calories, ingredients, mealType)) == 1
...
def test_no_calories_ingredients_mealType_match():
    ...
    calories = 700
    mealType = "dinner"
    assert len(getRecipesWithCaloriesIngredientsMealType(calories, ingredients, mealType)) == 0
